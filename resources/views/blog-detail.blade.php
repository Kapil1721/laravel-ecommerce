                            ...
                            <div class="inner">
                                ...
                                <div class="reply-comment">
                                    ...
                                    <div class="reply-comment-wrap">
                                        ...
                                        <div class="reply-comment-item">
                                            <div class="image">
                                                <img src="images/avatar/user-3.jpg" alt="">
                                            </div>
                                            <div class="content">
                                                <div class="d-flex justify-content-between gap-10 flex-wrap">
                                                    <div>
                                ...
                                <div>
                                    <div class="relatest-post-item hover-image">
                                        ...
                                        <div class="content">
                                            ...
                                            <h6 class="title fw-5">
                                                <a class="link" href="blog-detail.php">The Ultimate Guide: Dressing Stylishly with Minimal Effort</a>
                                            </h6>
                                        </div>
                                    </div>
                                    <div class="relatest-post-item style-row hover-image">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="title text-title">
                                                <a class="link" href="blog-detail.php">10 Must-Have Wardrobe Staples for Every Season</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="relatest-post-item style-row hover-image">
                                        <div class="image">
                                            <img class="lazyload" data-src="images/blog/sidebar-3.jpg" src="images/blog/sidebar-3.jpg" alt="">
                                        </div>
                                        <div class="content">
                                            <div class="meta">
                                                <div class="meta-item gap-8">
                                            ...
                                            <div class="title text-title">
                                                <a class="link" href="blog-detail.php">How to Transition Your Wardrobe from Day to Night</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="relatest-post-item style-row hover-image">
                                        <div class="image">
                                            <img class="lazyload" data-src="images/blog/sidebar-4.jpg" src="images/blog/sidebar-4.jpg" alt="">
                                        </div>
                                        <div class="content">
                                            <div class="meta">
                                                <div class="meta-item gap-8">
                                            ...
                                            <div class="title text-title">
                                                <a class="link" href="blog-detail.php">How to Incorporate Classic Pieces into Modern Outfits</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="relatest-post-item style-row hover-image">
                                        <div class="image">
                                            <img class="lazyload" data-src="images/blog/sidebar-5.jpg" src="images/blog/sidebar-5.jpg" alt="">
                                        </div>
                                        <div class="content">
                                            <div class="meta">
                                                <div class="meta-item gap-8">
                                            ...
                                            <div class="title text-title">
                                                <a class="link" href="blog-detail.php">How to Wear the Latest Fashion Trends Every Day</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="wg-blog style-1 hover-image">
                                        ...
                                        <div class="content">
                                            ...
                                            <div>
                                                <h6 class="title fw-5">
                                                    <a class="link" href="blog-detail.php">How Technology is Transforming the Industry</a>
                                                </h6>
                                ...
                                <div class="swiper-slide">
                                    <div class="wg-blog style-1 hover-image">
                                        ...
                                        <div class="content">
                                            ...
                                            <div>
                                                <h6 class="title fw-5">
                                                    <a class="link" href="blog-detail.php">The Future of Fashion How Technology Transforms the Industry</a>
                                                </h6>
                                                <div class="body-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sed vulputate massa.</div>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="wg-blog style-1 hover-image">
                                        ...
                                        <div class="content">
                                            ...
                                            <div>
                                                <h6 class="title fw-5">
                                                    <a class="link" href="blog-detail.php">From Concept to Closet The Journey of Sustainable Fashion</a>
                                                </h6>
                                                <div class="body-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sed vulputate massa.</div>
                                            </div>
                                        </div>
