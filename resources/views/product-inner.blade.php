            ...
            <div class="container">
                <div class="tf-breadcrumb-wrap">
                    <div class="tf-breadcrumb-list">
                        <a href="index.php" class="text text-caption-1">Homepage</a>
                    ...
                    <div class="tf-breadcrumb-prev-next">
                        <a href="product-bottom-thumbnails.php" class="tf-breadcrumb-prev">
                            <i class="icon icon-arrLeft"></i>
                        </a>
                        <a href="product-bottom-thumbnails.php" class="tf-breadcrumb-back">
                            <i class="icon icon-squares-four"></i>
                        </a>
                        <a href="product-bottom-thumbnails.php" class="tf-breadcrumb-next">
                            <i class="icon icon-arrRight"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="tf-add-cart-product">
                ...
                <div class="content">
                    <div class="text-title">
                        <a class="link" href="product-inner.php">Biker-style leggings</a>
                    </div>
                                    ...
                                    <div class="tf-product-info-choose-option">
                                        ...
                                        <ul class="tf-product-info-sku">
                                            ...
                                            <li>
                                                ...
                                                <p class="text-caption-1 text-1">e-Commerce</p>
                                            </li>
                                            <li>
                                            ...
                                            <div class="reply-comment-wrap">
                                                ...
                                                <div class="reply-comment-item type-reply">
                                                    <div class="user">
                                                        ...
                                                        <div>
                                                            <h6>
                                                                <a href="#" class="link">Reply from e-Commerce</a>
                                                            </h6>
                                                            <div class="day text-secondary-2 text-caption-1">1 days ago  &nbsp;&nbsp;&nbsp;-</div>
                                                        </div>
                                                    </div>
                                                    <p class="text-secondary">We love to hear it! Part of what we love most about e-Commerce is how much it empowers store owners like yourself to build a beautiful website without having to hire a developer :) Thank you for this fantastic review!</p>
                                                </div>
                                                <div class="reply-comment-item">
                                                    <div class="user">
                                                        <div class="image">
                            ...
                            <li class="accordion-product-item">
                                ...
                                <div id="accordion-4" class="collapse" data-bs-parent="#accordion-product">
                                    <div class="accordion-content tab-policies">
                                        ...
                                        <p class="mb_12 text-secondary">At e-Commerce, we stand behind the quality of our products. If you're not completely satisfied with your purchase, we offer hassle-free returns within 30 days of delivery.</p>
