...
<?include "header.php"; ?>
        ...
        <!-- search -->
        <section class="flat-spacing page-search-inner">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        ...
                        <div class="tf-col-quicklink">
                            ...
                            <a class="link" href="shop-default-grid.php">Fashion</a>,
                            <a class="link" href="shop-default-grid.php">Men</a>,
                            <a class="link" href="shop-default-grid.php">Women</a>,
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="flat-spacing pt-0">
            <div class="container">
                <div class="heading-section text-center wow fadeInUp">
                    <h3 class="heading">Product Recent</h3>
                </div>
